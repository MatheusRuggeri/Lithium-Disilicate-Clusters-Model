...
def process_frame(img, squares, last_circle_left, last_circle_right, r_min, r_max, circ_param_1, circ_param_2):
...
def calculate_distance(detected_circles, squares):
    if detected_circles is not None:
        ...
        if x1 != 0 and x2 != 0 and y1 != 0 and y2 != 0:
            ...
            return last_circle_left, last_circle_right, distance
    return last_circle_left, last_circle_right, 0
...
if __name__ == "__main__":
    ...
    x, y, r = 0, 0, 0
    last_circle_left, last_circle_right = 0, 0
    dist_list = []
    ...
    for i in range(first_frame, last_frame + 1):
        ...
        imgf, crop_img, detected_circles = process_frame(img, squares, last_circle_left, last_circle_right,
                                                         r_min, r_max, circ_param_1, circ_param_2)

        # Calculate the distance and update the last_circle_left and last_circle_right values
        last_circle_left, last_circle_right, distance = calculate_distance(detected_circles, squares)
